...
if (!empty($_POST)) {
    $edited_data = array(
        ...
        "gd_bankSwiftCode" => $_POST["bankSwiftCode"],
        "gd_bankIBAN" => $_POST["gd_bankIBAN"],
        "gd_bankBranchCode" => $_POST["bankBranchCode"],
        "gd_bankAccountNumber" => $_POST["AccountNumber"],
        "gd_registrationNo" => $_POST["registrationNo"]
    );
    ...
    <div class="row d-flex align-items-center vh-100">
        <form class="d-flex flex-column gap-3" name="pdf_data_form" action="" method="post">
            ...
            <div class="form-group">
                ...
                <input class="form-control" type="text" value='<?= $data["gd_bankAccountNumber"] ?>' name="bankAccountNumber" />
            </div>
            <div class="form-group">
